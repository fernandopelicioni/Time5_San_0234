...
Screen.Cursor:=CrHourGlass;
            // Inicia Gravação
            Memo1.Lines.Add('Iniciando Gravação');
                 ...
                 Begin
                      ...
                      if not eof then
                            begin
                                   repeat
                                          ...
                                          if pai.QrColigadas.FieldByName('cod_coligada').AsString='1' then
                                             begin
                                                    ...
                                                    Saida:=
                                                    FormatFloat('00000000',QrProventos.FieldByName('CHAPA').AsInteger) +
                                                    '                '  +
                                          ...
                                          if pai.QrColigadas.FieldByName('cod_coligada').AsString='4' then
                                             begin
                                                    Memo1.Lines.Add('Gravando : '+ FormatFloat('000000',QrProventos.FieldByName('Chapa').AsInteger));
                                                    Saida:='  '+
                                   ...
                                   until Eof;
                                   CloseFile(Arqtxt);
                                   memo1.Lines.Add('Gravação Concluida');
                                   ShowMessage('Você ja pode utilizar o arquivo GERADO!');
                            end;
                 End;
