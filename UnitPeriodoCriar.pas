...
var
    ...
    Periodo:integer;
begin
        if (MessageDlg('Confirma criação do período?', mtConfirmation, [mbYes, mbNo], 0) = mrYes) then
              begin
...
//                            DtPeriodo.DataSet.FieldByName('Tpe_Ativo').AsString:=MaskEdit1.Text;
                              ...
                              // Iniciar a gravação da tabela Dia_Periodo, onde todos os dias irao ser gravados
