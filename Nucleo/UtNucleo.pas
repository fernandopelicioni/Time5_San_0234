...
begin
           With Pai.QrCenarios do
                begin
                       ...
                       open;
                       Panel2.Caption:='      WORK Bus - Gerente de Operações | Cenário atual : '+ FieldByName('Tce_Des').AsString + '    |    Versão : ' + FormIniciaSistema.EditVersao.Caption;
                end;
end;
...
begin
           With Pai.QrCenarios do
                begin
                       ...
                       Panel2.Caption:='      WORK Bus - Gerente de Operações | Cenário atual : '+ FieldByName('Tce_Des').AsString;
                end;
