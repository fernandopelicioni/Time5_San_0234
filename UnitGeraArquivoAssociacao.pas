...
//                                 try
                                       ...
                                       Rewrite(Arquivo);
//                                 Except
//                                        MessageBox(0, 'O nome para o arquivo informado não é valido, verifique!', 'Inválido', MB_ICONWARNING or MB_OK);
//                                        Abort;
//                                 end;
                                 repeat
                            ...
                            begin
                                  MessageBox(0, 'Não foram encontrados dados nesta data, verifique se o movimento ja foi gerado e ajsutado!', 'Dados Não encontrados', MB_ICONEXCLAMATION or MB_OK);
