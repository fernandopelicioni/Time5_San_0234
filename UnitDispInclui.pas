...
begin
           ...
           VDtFim             :=(DtFim.Date);
            ...
            q.SQL.clear;
            Q.SQL.Text:=('SELECT * FROM TB_PTOMOV5 WHERE PTO_DATA >=:INICIO AND PTO_DATA<=:FIM AND PTO_CHAPA=:CHAPA and PTO_COLIGADA=:COLIGADA AND PTO_PERIODO=:PERIODO');
...
procedure TFormDispInclui.DtIniExit(Sender: TObject);
begin
