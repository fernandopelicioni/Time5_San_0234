...
begin
             ...
             if (VDia >= VInicioPeriodo) and (VDia <= VFimPeriodo) then
                   begin
                          MessageBox(0, '******** A V I S O *********'+#13+#10+' Peça que todos os usuários do sistema não executem nenhuma tarefa até que eu tenha terminado'+#13+#10+''+#13+#10+'***************************', 'Importante', MB_ICONWARNING or MB_OK);
