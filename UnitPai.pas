...
begin
                ...
                WITH Q DO
                    BEGIN
                          ...
                          If NOT EOF then
                                  BEGIN
                                         //INICIA GRAVAÇAO DOS DADOS ENCONTRADOS NA TABELA TB_PTOREL01
...

 {
   With SqlMov do
       Begin
             Close;
             Sql.clear;
             if TipoEntrada = 0 then // caso seja inserção
                    begin
                         Sql.Add('Insert Into');
...
VHora, VMinuto : Integer;
begin
                // **************************** Calcula Hora Extra Modelo 2 (COMPENSADA) para perfis de função com id 2 no modo de compensacao****************************
                Q:=tadoquery.create(nil);
                Q.Connection:=Genoma;
                q.CommandTimeout:=500;
                Q2:=tadoquery.create(nil);
