                              ...
                              begin
                                   ...
                                   if QrHora.FieldByName('Iti_Sentido').AsString = '0' then
                                         begin
                                              ...
                                              DtBse.DataSet.FieldByName('Cbse_IdaText').AsString:=Copy(QrHora.FieldByName('Hor_Inf').AsString,1,10);
                                         end
                                         else
                                         begin
                                              DtBse.DataSet.FieldByName('Cbse_VoltaText').AsString:=Copy(QrHora.FieldByName('Hor_Inf').AsString,1,10);
