...
begin
       ...
       with QrTemp do
            begin
                  ...
                  if Not Eof then
                        begin
                              if (MessageDlg('Atenção,'+#13+#10+''+#13+#10+'Ja existem associações para esta data, antes de continuar, irei subescrever todos os registros, Prosseguir?', mtConfirmation, [mbYes, mbNo], 0) in [mrYes]) then
                                      begin
                                            close;
                                            sql.Clear;
                                      ...
                                      begin
                                            Close;
                                            MessageBox(0, 'Ok,'+#13+#10+'Geração cancelada, escolha outra data!', 'Cancelado', MB_ICONWARNING or MB_OK);
                                            Abort;
                                      end;
                        end
                        else
                                              ...
                                              begin
                                                   ...
                                                   with Relatorio.QrGpsHorVei do
                                                        begin
                                                              ...
                                                              if not eof then
                                                                    begin
                                                                          MessageBox(0, 'Observe que existem horários sem veículos associados, a seguir, emitirei um relatório para consulta!', 'Consistencia', MB_ICONWARNING or MB_OK);
